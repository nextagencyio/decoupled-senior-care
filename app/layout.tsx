...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Senior Care',
    template: `%s | Senior Care`
  },
  description: 'At Golden Horizons, we believe every senior deserves to live with dignity, joy, and purpose. Our award-winning communities offer personalized care plans, engagi',
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
