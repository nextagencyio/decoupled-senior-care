...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Get in touch with Golden Horizons Senior Living. Schedule a tour, ask about our communities, or learn about care options for your loved one.',
  keywords: ['Contact Senior Care', 'Schedule Tour', 'Senior Living Information', 'Care Options'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about our senior care communities? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@goldenhorizons.com</p>
                    <p className="text-gray-600">support@goldenhorizons.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 567-8930</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Visits: Daily 9:00 AM - 8:00 PM<br />
                      Admissions Office: Monday - Friday 9:00 AM - 5:00 PM
                    </p>
                  </div>
                </div>
              </div>
